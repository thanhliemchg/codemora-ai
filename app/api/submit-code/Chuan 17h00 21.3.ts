...
/* ===== BÀI HS TỰ SINH ===== */
  ...
  if(body.submission_id){
    ...
    if(sub?.exercise_text){
      realExerciseText = sub.exercise_text
    }
  }
}
...
Hãy nhận xét chi tiết nhưng ngắn gọn về code của học sinh dựa trên các tiêu chí sau:
- Đúng/sai logic
- Hiệu quả
- Có lỗi gì không
